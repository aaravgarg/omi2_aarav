...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_HEAP_SIZE, 70000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_LOG_MESSAGE_QUEUE_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_OMI_NRF5340, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_OMI_NRF5340_NRF5340_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_DUMMY_BUF_SIZE, 400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_OFFLINE_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_ACCELEROMETER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_BUTTON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_SPEAKER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_BATTERY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_USB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_HAPTIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OMI_ENABLE_IMU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_LED_PIN, 13);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIC_SAMPLE_RATE, 16000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIC_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIC_THREAD_PRIORITY, 5);
